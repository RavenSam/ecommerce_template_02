...
export default function Discount() {
   return (
      <div className="relative rounded-md overflow-hidden">
         <Image src="/discount.jpg" alt="product" layout="fill" objectFit="cover" className="" />

         <div className="absolute inset-0 bg-white bg-opacity-70" />

         <div className="relative flex flex-col items-center justify-center text-center text-gray-800 py-8 md:py-16 px-2 space-y-6">
