      ...
      <div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2  gap-4 ">
            <div className="relative min-h-[15rem] row-span-2 rounded-md overflow-hidden">
               <Image src="/assets/clothing.jpg" alt="product" layout="fill" objectFit="cover" />
            ...
            <div className="relative min-h-[15rem]  rounded-md overflow-hidden">
               <Image src="/assets/clothing-2.jpg" alt="product" layout="fill" objectFit="cover" />

               <div className="absolute inset-0 bg-gradient-to-t from-[#000000b8]" />

               <div className="text-white absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-semibold tracking-wider mb-4">Popular</h3>
                  <a href="#" className="btn-t ">
                     shop now
                  </a>
               </div>
            ...
            <div className="relative min-h-[15rem]  rounded-md overflow-hidden">
               <Image src="/assets/women-2.jpg" alt="product" layout="fill" objectFit="cover" />

               <div className="absolute inset-0 bg-gradient-to-t from-[#000000b8]" />

               <div className="text-white absolute bottom-0 left-0 p-4">
                  <h3 className="text-xl font-semibold tracking-wider mb-4">Relevant</h3>
                  <a href="#" className="btn-t ">
                     shop now
                  </a>
               </div>
